...
_lr_productions = [
  ...
  ('init -> BLOQUES','init',1,'p_init','gramaticaC3D.py',110),
  ('BLOQUES -> BLOQUES BLOQUE','BLOQUES',2,'p_bloques_lista','gramaticaC3D.py',114),
  ('BLOQUES -> BLOQUE','BLOQUES',1,'p_bloques_final','gramaticaC3D.py',120),
  ('BLOQUE -> rpackage rmain pcoma','BLOQUE',3,'p_instruccion_package','gramaticaC3D.py',127),
  ('BLOQUE -> rimport apar cadena cpar pcoma','BLOQUE',5,'p_instruccion_import','gramaticaC3D.py',131),
  ('BLOQUE -> rvar id acor int ccor rfloat pcoma','BLOQUE',7,'p_declaraheapstack','gramaticaC3D.py',137),
  ('BLOQUE -> rvar IDS rfloat pcoma','BLOQUE',4,'p_declaraciontemporales','gramaticaC3D.py',142),
  ('BLOQUE -> rfunc id apar cpar alla INSTRUCCIONES clla','BLOQUE',7,'p_voids','gramaticaC3D.py',146),
  ('BLOQUE -> rfunc rmain apar cpar alla INSTRUCCIONES clla','BLOQUE',7,'p_main','gramaticaC3D.py',151),
  ('IDS -> IDS coma id','IDS',3,'p_lista_ids','gramaticaC3D.py',156),
  ('IDS -> id','IDS',1,'p_lista_ids2','gramaticaC3D.py',162),
  ('INSTRUCCIONES -> INSTRUCCIONES INSTRUCCION','INSTRUCCIONES',2,'p_instrucciones_lista','gramaticaC3D.py',170),
  ('INSTRUCCIONES -> INSTRUCCION','INSTRUCCIONES',1,'p_instrucciones_final','gramaticaC3D.py',176),
  ('INSTRUCCION -> id igual OPERANDO OPERACION OPERANDO pcoma','INSTRUCCION',6,'p_asignacion1','gramaticaC3D.py',183),
  ('INSTRUCCION -> id igual OPERANDO pcoma','INSTRUCCION',4,'p_asignacion2','gramaticaC3D.py',188),
  ('INSTRUCCION -> id igual id acor rint apar id cpar ccor pcoma','INSTRUCCION',10,'p_asignacion3','gramaticaC3D.py',193),
  ('INSTRUCCION -> id acor rint apar id cpar ccor igual OPERANDO pcoma','INSTRUCCION',10,'p_asignacion4','gramaticaC3D.py',198),
  ('INSTRUCCION -> id dosp','INSTRUCCION',2,'p_etiqueta','gramaticaC3D.py',203),
  ('INSTRUCCION -> rfmt dot rprintf apar cadena coma rint apar OPERANDO cpar cpar pcoma','INSTRUCCION',12,'p_fmt','gramaticaC3D.py',208),
  ('INSTRUCCION -> rfmt dot rprintf apar cadena coma OPERANDO cpar pcoma','INSTRUCCION',9,'p_fmt2','gramaticaC3D.py',213),
  ('INSTRUCCION -> rfmt dot rprintf apar cadena coma cadena cpar pcoma','INSTRUCCION',9,'p_fmt3','gramaticaC3D.py',218),
  ('INSTRUCCION -> rif OPERANDO CONDICION OPERANDO alla rgoto id pcoma clla','INSTRUCCION',9,'p_if','gramaticaC3D.py',223),
  ('INSTRUCCION -> rgoto id pcoma','INSTRUCCION',3,'p_goto','gramaticaC3D.py',228),
  ('INSTRUCCION -> rreturn pcoma','INSTRUCCION',2,'p_return','gramaticaC3D.py',233),
  ('INSTRUCCION -> id apar cpar pcoma','INSTRUCCION',4,'p_llamadafn','gramaticaC3D.py',238),
  ('CONDICION -> mayor','CONDICION',1,'p_condicion','gramaticaC3D.py',244),
  ('CONDICION -> mayori','CONDICION',1,'p_condicion','gramaticaC3D.py',245),
  ('CONDICION -> menor','CONDICION',1,'p_condicion','gramaticaC3D.py',246),
  ('CONDICION -> menori','CONDICION',1,'p_condicion','gramaticaC3D.py',247),
  ('CONDICION -> igualigual','CONDICION',1,'p_condicion','gramaticaC3D.py',248),
  ('CONDICION -> diferente','CONDICION',1,'p_condicion','gramaticaC3D.py',249),
  ('OPERACION -> mas','OPERACION',1,'p_operacion','gramaticaC3D.py',254),
  ('OPERACION -> menos','OPERACION',1,'p_operacion','gramaticaC3D.py',255),
  ('OPERACION -> por','OPERACION',1,'p_operacion','gramaticaC3D.py',256),
  ('OPERACION -> div','OPERACION',1,'p_operacion','gramaticaC3D.py',257),
  ('OPERANDO -> id','OPERANDO',1,'p_operando','gramaticaC3D.py',262),
  ('OPERANDO -> int','OPERANDO',1,'p_operando2','gramaticaC3D.py',266),
  ('OPERANDO -> float','OPERANDO',1,'p_operando3','gramaticaC3D.py',270),
  ('OPERANDO -> id dot id apar OPERANDO coma OPERANDO cpar','OPERANDO',8,'p_operando4','gramaticaC3D.py',274),
]
